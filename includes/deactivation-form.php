            ...
            <div class="ps-zendesk-chat-popup-body">
                ...
                <ul id="ps-zendesk-chat-reason-list">
                    ...
                    <li class="ps-zendesk-chat-reason has-input" data-input-type="textfield">
                        ...
                        <div class="ps-zendesk-chat-internal-message"></div>
                        <div class="ps-zendesk-chat-reason-input"><span class="message error-message "><?php _e( 'Kindly tell us the Plugin name.', 'widget-for-zendesk-chat-via-api' ); ?></span><input type="text" name="better_plugin" placeholder="What's the plugin's name?"></div>
                    </li>
                    <li class="ps-zendesk-chat-reason" data-input-type="" data-input-placeholder="">
                        <label>
                            <span>
                    ...
                    <li class="ps-zendesk-chat-reason has-input" data-input-type="textfield" >
                        ...
                        <div class="ps-zendesk-chat-internal-message"></div>
                        <div class="ps-zendesk-chat-reason-input"><span class="message error-message "><?php _e( 'Kindly tell us the reason so we can improve.', 'widget-for-zendesk-chat-via-api' ); ?></span><input type="text" name="other_reason" placeholder="Kindly tell us the reason so we can improve."></div>
                    </li>
                </ul>
            </div>
            <div class="ps-zendesk-chat-popup-footer">
                <label class="ps-zendesk-chat-anonymous"><input type="checkbox" /><?php _e( 'Anonymous feedback', 'widget-for-zendesk-chat-via-api' ); ?></label>
                <input type="button" class="button button-secondary button-skip ps-zendesk-chat-popup-skip-feedback" value="<?php _e( 'Skip & Deactivate', 'widget-for-zendesk-chat-via-api'); ?>" />
                <div class="action-btns">
                    <span class="ps-zendesk-chat-spinner"><img src="<?php echo admin_url( '/images/spinner.gif' ); ?>" alt=""></span>
                    <input type="submit" class="button button-secondary button-deactivate ps-zendesk-chat-popup-allow-deactivate" value="<?php _e( 'Submit & Deactivate', 'widget-for-zendesk-chat-via-api'); ?>" disabled="disabled" />
                    <a href="#" class="button button-primary ps-zendesk-chat-popup-button-close"><?php _e( 'Cancel', 'widget-for-zendesk-chat-via-api' ); ?></a>
                </div>
            </div>
        </form>
    </div>
